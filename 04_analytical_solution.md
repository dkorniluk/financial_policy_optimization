...
<img src="https://render.githubusercontent.com/render/math?math=L(x, \lambda, \mu) = f(x) %2B \sum_{j=1}^{5} \mu_{j3} g_{j3}(x) = \alpha \ln c_{3} %2B (1 - \alpha) \ln ( (1-\delta) k_{3} %2B (1 %2B \theta) U_{3} %2B i_{3}) %2B \beta \alpha \ln (\frac{ \alpha ( \frac{y_{5} %2B U_{5}}{\chi%2B r} \frac{1}{3} \left(\sum_{\tau=2}^{3} \frac{y_{\tau} - c_{\tau} - r b_{\tau}}{y_{\tau} %2B u_{\tau}} %2B \frac{y_{4} - r (b_{3} %2B \theta U_{3} %2B c_{3} %2B i_{3} %2B rb_{3} - y_{3})}{y_{4} %2B U_{4}}  \right) - (1%2Br)(b_{3} %2B \theta U_{3} %2B c_{3} %2B i_{3} %2B rb_{3} - y_{3}))}{1 %2B \frac{1}{3} \frac{y_{5} %2B U_{5}}{\chi %2B r} \frac{1}{y_{4} %2B U_{4}}}  %2B   \frac{ \alpha ( y_{4} %2B (1-\delta)((1-\delta)k_{3} %2B (1%2B\theta)U_{3} %2B i_{3}) %2B U_{4} ) }{1 %2B \frac{1}{3} \frac{y_{5} %2B U_{5}}{\chi %2B r} \frac{1}{y_{4} %2B U_{4}}}) %2B \beta (1-\alpha) \ln ((1-\alpha) (1-\delta) ((1-\delta) k_{3} %2B (1%2B\theta) U_{3} %2B i_{3}) %2B (1-\alpha) U_{4} %2B (1 - \alpha) (\frac{y_{5} %2B U_{5}}{\chi%2B r} \frac{1}{3} \left(  \frac{y_{2} - c_{2} - r b_{2}}{y_{2} %2B u_{2}} %2B \frac{y_{3} - c_{3} - r b_{3}}{y_{3} %2B U_{3}} %2B \frac{y_{4} - r (b_{3} %2B \theta U_{3} %2B c_{3} %2B i_{3} %2B rb_{3} - y_{3})}{y_{4} %2B U_{4}} \right)    
 -  (1%2Br) (b_{3} %2B \theta U_{3} %2B i_{3} %2B c_{3} %2B r b_{3} - y_{3}) %2B y_{4}))  %2B \mu_{53} \left( \frac{(\chi %2B r) \left(b_{3} %2B \theta U_{3} %2B i_{3} %2B c_{3} %2B r b_{3} - y_{3} \right)}{y_{4} %2B U_{4}} - \frac{1}{3} \left( \frac{y_{1} - c_{1} - r b_{1}}{y_{1} %2B u_{1}} %2B \frac{y_{2} - c_{2} - r b_{2}}{y_{2} %2B u_{2}} %2B \frac{y_{3} - c_{3} - r b_{3}}{y_{3} %2B U_{3}} \right) \right)">.
