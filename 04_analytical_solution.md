...
<img src="https://render.githubusercontent.com/render/math?math=<img src="https://render.githubusercontent.com/render/math?math=\mathcal{L}(x, \lambda, \mu)   =   f(x) %2B \sum_{j=1}^{5} \mu_{j3} g_{j3}(x) =   \\
