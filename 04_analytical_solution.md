...
gdzie <img src="https://render.githubusercontent.com/render/math?math=f: \mathbb{R}^{n} \rightarrow \mathbb{R},  \bm{h}: \mathbb{R}^{n} \rightarrow \mathbb{R}^{m}, m \leq n i \bm{g}: \mathbb{R}^{n} \rightarrow \mathbb{R}^{p}">.
